 ...
 */
public class AudioProgressWheel extends View {

	public static final byte PLAY_WHEEL = 0;
	public static final byte RECORD_WHEEL = 1;
    ...
    /**
     * The constructor for the AudioProgressWheel
     *
     * @param context
     * @param attrs
     */
    public AudioProgressWheel(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        contourSize = a.getDimension(R.styleable.ProgressWheel_contourSize, contourSize);
    ...
    */
     ...
     */
    public void incrementProgress(int total_time) {
        isSpinning = false;
        progress += 360/total_time;
//        if (progress > 360)
//            progress = 0;
