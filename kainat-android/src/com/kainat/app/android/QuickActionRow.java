 ...
 */
public class QuickActionRow extends PopupWindows implements OnDismissListener {
	 ...
	 */
	public QuickActionRow(Context context) {
		super(context);
		...
		container.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (mItemClickListener != null) {
                    mItemClickListener.onItemClick(QuickActionRow.this, pos, actionId);
                }
	 ...
	 */
	public void setOnDismissListener(QuickActionRow.OnDismissListener listener) {
	...
	public interface OnActionItemClickListener {
		public abstract void onItemClick(QuickActionRow source, int pos, int actionId);
	}
