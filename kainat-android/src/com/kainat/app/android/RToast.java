...
public class RToast extends PopupWindows implements OnDismissListener {
...
this.context =context ;
		...
		mTrackAnim 	= AnimationUtils.loadAnimation(context, R.anim.grow_from_top);
		...
		container.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (mItemClickListener != null) {
                    mItemClickListener.onItemClick(RToast.this, pos, actionId);
                }
...
//		setAnimationStyle(screenWidth, anchorRect.centerX(), onTop);
		...
		Utilities.startAnimition(context, mRootView, R.anim.grow_from_top);
//		if (mAnimateTrack) mTrack.startAnimation(mTrackAnim);
	 ...
	 */
	public void setOnDismissListener(RToast.OnDismissListener listener) {
	...
	public interface OnActionItemClickListener {
		public abstract void onItemClick(RToast source, int pos, int actionId);
	}
