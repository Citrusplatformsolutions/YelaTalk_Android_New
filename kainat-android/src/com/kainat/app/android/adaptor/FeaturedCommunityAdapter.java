...
public class FeaturedCommunityAdapter extends CursorAdapter {

	RTAdaptorInf adaptorInf;
    public void setAdaptorInf(RTAdaptorInf adaptorInf) {
		this.adaptorInf= adaptorInf;
	}
	public FeaturedCommunityAdapter(Context context, Cursor c, boolean autoRequery,RTAdaptorInf adaptorInf) {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        View retView = inflater.inflate(R.layout.community_list_row, parent, false);
        return retView;
    }
    @Override
