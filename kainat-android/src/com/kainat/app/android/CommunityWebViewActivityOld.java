...
public class CommunityWebViewActivityOld extends UIActivityManager {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.community_webview_layout_old);
		init();
	...
	private void init() {
		...
		wv.loadUrl("file:///android_asset/termcondition_old.html");
