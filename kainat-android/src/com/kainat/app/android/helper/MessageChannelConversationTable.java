...
public class MessageChannelConversationTable {
	
	public static final String TABLE = "CHANNEL_CONVERSATION_LIST";
	...
	public static final String VIDEO_ID_8 = "VIDEO_ID_8";
	...
	private static final String CREATE_TABLE = "create table "
			...
			+ UNREAD_MESSAGE_COUNT + " integer,"// 1
