...
public class CommunityTable {
	...
	private static final String CREATE_COMMUNITY_MEDIA = "create table "
			+ TABLE + "(" + COLUMN_ID
	...
	public static void onCreate(SQLiteDatabase database) {
		database.execSQL(CREATE_COMMUNITY_MEDIA);
	}

	public static void onUpgrade(SQLiteDatabase database, int oldVersion,
			int newVersion) {
		Log.w(CommunityTable.class.getName(), "Upgrading database from version "
