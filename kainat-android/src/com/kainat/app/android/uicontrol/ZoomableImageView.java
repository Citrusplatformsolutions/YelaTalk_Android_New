...
//
////    @Override
//    protected void onSizeChangedXXX(int width, int height, int oldWidth, int oldHeight) {
...
//                	if(SettingData.sSelf.isIm())
//                	System.out.println("----DEFAULT_SCALE_FIT_INSIDE if");
...
//                if(imgWidth > containerWidth) {   
//                	if(SettingData.sSelf.isIm())
//                	System.out.println("----DEFAULT_SCALE_FIT_INSIDE else  1");
//                    initY = (containerHeight - (int)imgHeight)/2;                   
//                    matrix.postTranslate(0, initY);
//                }
//                else {                    
//                	if(SettingData.sSelf.isIm())
//                	System.out.println("----DEFAULT_SCALE_FIT_INSIDE else  2");
...
//            }
//
////            onTouchEvent(new android.view.MotionEvent() );
//            invalidate();           
//        }
//    }
//
...
//
////    @Override
//    public boolean onTouchEventXXX(MotionEvent event) {    
////    	if(1==1 && !SettingData.sSelf.isIm())
////    		return false ;
