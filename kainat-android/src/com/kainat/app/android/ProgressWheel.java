...
public class ProgressWheel extends View {
	...
	public int barColor = 0xAA000000;
	public int circleColor = 0x00000000;
	public int rimColor = 0xAADDDDDD;
	...
	public RectF rectBounds = new RectF();
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawArc(circleBounds, 180, 180, false, rimPaint); // half circle
		//Draw the bar
		if(isSpinning) {
			//canvas.drawArc(circleBounds, progress - 90, barLength, false,  // orginal for full circle
				//barPaint);
			canvas.drawArc(circleBounds, 180, 180, false, rimPaint); // half circle

		} else {
			//canvas.drawArc(circleBounds, -90, progress, false, barPaint); //original for circle
			canvas.drawArc(circleBounds, 180, progress, false, barPaint); //half circle
		}
